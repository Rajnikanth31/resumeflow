...
export const Hero = () => {
  return (
    <section className="relative w-full py-20 lg:py-32 overflow-hidden bg-zinc-950 text-white rounded-3xl px-8 lg:px-16 shadow-2xl border border-zinc-800/80">
      ...
      <div className="relative z-10 grid grid-cols-1 gap-12 lg:grid-cols-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl font-heading leading-[1.1] bg-gradient-to-r from-white via-zinc-100 to-zinc-400 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
            ...
            <Link
              href="/resume-parser"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-zinc-900 border border-zinc-800 px-6 py-3 text-sm font-bold text-zinc-300 hover:bg-zinc-800 hover:text-white transition-all"
            >
              Verify ATS Score
            </Link>
          </div>

          <div className="flex items-center gap-4 pt-8 border-t border-zinc-900 text-xs text-zinc-500">
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          <div className="relative w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900/60 p-1.5 shadow-2xl backdrop-blur-sm group hover:border-zinc-700/60 transition-all duration-500">
            ...
            <div className="relative rounded-xl overflow-hidden bg-zinc-950 flex items-center justify-center min-h-[380px] p-4">
              <AutoTypingResume />
            </div>
          </div>
        </div>
